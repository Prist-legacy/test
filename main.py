...
#DATABASE CONNECT
DATABASE_URL = "postgresql://postgres:ee2CToTS2poru12R5tlx@containers-us-west-15.railway.app:7561/railway"
def connect_to_db():
...
def create_oders():
    conn = connect_to_db()
    cursor = conn.cursor()
    create_orders = "CREATE TABLE IF NOT EXISTS orders (date varchar(13) NOT NULL,user_id BIGINT,order_no TEXT NOT NULL,order_type varchar(10) DEFAULT 'VIP',PRIMARY KEY(user_id))"
